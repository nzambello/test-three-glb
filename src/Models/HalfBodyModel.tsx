...
const baseUrl = process.env.NODE_ENV === 'development' ? '' : '/test-three-glb'

export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(baseUrl + '/e680fa00-8f01-4000-8934-354552801de4.glb')
...
useGLTF.preload(baseUrl + '/e680fa00-8f01-4000-8934-354552801de4.glb')
